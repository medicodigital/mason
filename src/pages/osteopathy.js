  ...
  <OsteopathyWrapper>
    ...
    <HeroHolder>
      ...
      <BlurbHolder>
        ...
        physical therapy that complements your body’s ability to heal naturally.
        Your internal organs, blood vessels, nerves and lymphatic system are
        supported by your musculo-skeletal system. Problems with one have an
        adverse effect on the other. That’s why social and psychological factors
        are important elements in our diagnosis since these impact health.
      </BlurbHolder>
    </HeroHolder>
    <StickyHolder>
      <Links />
    ...
    <BottomHolder>
      <BlurbPicContainer>
        ...
        <BlurbHolder>
          ...
          familiar with. It comprises a number of techniques such as muscle and
          connective tissue stretching, rhythmic joint movement, gentle release
          techniques and the occasional high thrust movement. It can cause the
          occasional cracking or popping noise but is generally painless.
        </BlurbHolder>
      </BlurbPicContainer>
      <BlurbPicContainer>
        <ImageHolder>
        ...
        <BlurbHolder>
          ...
          the head and body. Releasing these stresses provides the patient with
          asense of well-being. Cranial osteopathy is a gentle treatment for a
      ...
      <BlurbHolder>
        ...
        detail. If we have enough information we will provide our diagnosis and
        recommendations. You may be asked to undress to your underclothes. If
        this is difficult for you please let us know and we will try to work
        around this but please wear something you are comfortable in. You are
        welcome to bring a friend or relative along with you. We have male and
        female osteopaths available. Let us know if you have a preference.
      </BlurbHolder>
      <ConditionsContainer>
